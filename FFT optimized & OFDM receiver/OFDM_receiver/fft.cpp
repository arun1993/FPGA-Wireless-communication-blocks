...
void fft(DTYPE X_R[SIZE], DTYPE X_I[SIZE], DTYPE OUT_R[SIZE],
	...
	DTYPE X_Copy_R[SIZE], X_Copy_I[SIZE],temp_OUT_R[SIZE], temp_OUT_I[SIZE];
	//#pragma HLS dataflow
	...
	fft_stage_last(Stage9_R, Stage9_I, temp_OUT_R, temp_OUT_I);


	bit_reverse(temp_OUT_R, temp_OUT_I, OUT_R, OUT_I);
